    ...
    %{
      ...
      checks: %{
        enabled: [
          ...
          # module. :active_nav, :nav_surface and :page_subtitle by the
          # marketing/parent/provider layouts via assigns[...], :fluid? and :live_resource
          # by Backpex.HTML.Layout. Deleting them because the check cannot see the reader
          # would break nav on ~30 pages.
          {Jump.CredoChecks.UnusedLiveViewAssign,
           ignored_assigns: [:active_nav, :nav_surface, :page_subtitle, :fluid?, :live_resource]},
