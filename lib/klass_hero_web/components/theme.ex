defmodule KlassHeroWeb.Theme do
  ...
  def text_color(:secondary), do: "text-[var(--fg-muted)]"
  def text_color(:secondary_dark), do: "text-[var(--fg-muted)]"
  ...
  def text_color(:muted), do: "text-[var(--fg-muted)]"
  def text_color(:subtle), do: "text-[var(--fg-subtle)]"
