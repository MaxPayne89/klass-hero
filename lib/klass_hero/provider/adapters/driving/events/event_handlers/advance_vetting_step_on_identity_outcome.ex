defmodule KlassHero.Provider.Adapters.Driving.Events.EventHandlers.AdvanceVettingStepOnIdentityOutcome do
  ...
  def handle(%IntegrationEvent{event_type: :identity_verification_passed, payload: payload}) do
  ...
  def handle(%IntegrationEvent{event_type: :identity_verification_failed, payload: payload}) do
