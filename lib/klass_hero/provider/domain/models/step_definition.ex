defmodule KlassHero.Provider.Domain.Models.StepDefinition do
  ...
  - `completed_via` - How the step reaches `:approved`. Currently `{:document, document_type}`
    for document-evidence steps; later evidence kinds (`:stripe_identity`, `:agreement`) are
    introduced in their own slices.
  ...
  @type completed_via :: {:document, String.t()}
