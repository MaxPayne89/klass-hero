...
## [0.99.2](https://github.com/MaxPayne89/klass-hero/compare/v0.99.1...v0.99.2) (2026-09-18)


### Code Refactoring

* addressing some slop ([#1611](https://github.com/MaxPayne89/klass-hero/issues/1611)) ([3ceddaa](https://github.com/MaxPayne89/klass-hero/commit/3ceddaadcd5f41ad993b7bcf4579b4e34f6e06d0))

## [0.99.1](https://github.com/MaxPayne89/klass-hero/compare/v0.99.0...v0.99.1) (2026-09-11)


### Code Refactoring

* simplify pass over the staff sessions popup ([#1600](https://github.com/MaxPayne89/klass-hero/issues/1600)) ([b85f22c](https://github.com/MaxPayne89/klass-hero/commit/b85f22c0f5c45b58ca41b1f120e55787e9abe2bd))
...
* warn against off-platform contact on both provider-contact surfaces ([#1558](https://github.com/MaxPayne89/klass-hero/issues/1558)) ([7585aa6](https://github.com/MaxPayne89/klass-hero/commit/7585aa6c0f3067e8b6412b99a9c812931979fd73))
...
* redesign provider profile hero as banner + identity card ([#1543](https://github.com/MaxPayne89/klass-hero/issues/1543)) ([4737b38](https://github.com/MaxPayne89/klass-hero/commit/4737b385fee94702c3030cf3ef4869b7d8b29c23)), closes [#1508](https://github.com/MaxPayne89/klass-hero/issues/1508)
...
* mark a child absent by hand, with a reason ([#1493](https://github.com/MaxPayne89/klass-hero/issues/1493)) ([2cf1529](https://github.com/MaxPayne89/klass-hero/commit/2cf15295ebff186762771996ae9241962df81060))
...
* show outstanding participant invitations on provider overview ([#1438](https://github.com/MaxPayne89/klass-hero/issues/1438)) ([337bca9](https://github.com/MaxPayne89/klass-hero/commit/337bca9203e7d12412a0759803b2ce4ae5722425)), closes [#1073](https://github.com/MaxPayne89/klass-hero/issues/1073)
...
* union session-level staff into messaging entitlement ([#1422](https://github.com/MaxPayne89/klass-hero/issues/1422)) ([199ac51](https://github.com/MaxPayne89/klass-hero/commit/199ac512d7f8145054b4c7c84fd3c63b76aaa257)), closes [#784](https://github.com/MaxPayne89/klass-hero/issues/784)

## [0.77.0](https://github.com/MaxPayne89/klass-hero/compare/v0.76.0...v0.77.0) (2026-08-20)


### Features

* authorize staff session access at session grain ([#1419](https://github.com/MaxPayne89/klass-hero/issues/1419)) ([dc2f6a1](https://github.com/MaxPayne89/klass-hero/commit/dc2f6a1a64df62713e95066a4a73dba1e3bbaa7b)), closes [#783](https://github.com/MaxPayne89/klass-hero/issues/783)
...
* record message attribution at send time ([#1379](https://github.com/MaxPayne89/klass-hero/issues/1379)) ([0a7dc77](https://github.com/MaxPayne89/klass-hero/commit/0a7dc77a134cdea4b804cc1af4bd0130ff204338)), closes [#1348](https://github.com/MaxPayne89/klass-hero/issues/1348)


### Code Refactoring

* drop the program_staff_participants table ([#1377](https://github.com/MaxPayne89/klass-hero/issues/1377)) ([81998e9](https://github.com/MaxPayne89/klass-hero/commit/81998e91d5241d60002313662656ab77497bd954)), closes [#1347](https://github.com/MaxPayne89/klass-hero/issues/1347)
...
* retry a tokenless invite's failing write instead of cancelling ([#1288](https://github.com/MaxPayne89/klass-hero/issues/1288)) ([6233bc9](https://github.com/MaxPayne89/klass-hero/commit/6233bc9db4fa8ff6479e74835bfab4824df19e88)), closes [#1248](https://github.com/MaxPayne89/klass-hero/issues/1248)
...
* collapse the two event structs into one, delete promotion ([#1211](https://github.com/MaxPayne89/klass-hero/issues/1211)) ([401b980](https://github.com/MaxPayne89/klass-hero/commit/401b980d7f179083739de93906e4e1466c365fce))
...
* generate sessions from a program's recurring schedule ([#1187](https://github.com/MaxPayne89/klass-hero/issues/1187)) ([b34c4f7](https://github.com/MaxPayne89/klass-hero/commit/b34c4f793bb38a0137d234dc09ab513797bc819e))
...
* cut fixed per-request cost on dashboard + admin; fix dead sessions tile ([#1112](https://github.com/MaxPayne89/klass-hero/issues/1112)) ([2e4a043](https://github.com/MaxPayne89/klass-hero/commit/2e4a04313dd868301f1549c5e30d3ba2dbf4531c))
...
* Interaction observability envelope for driven-adapter I/O ([#981](https://github.com/MaxPayne89/klass-hero/issues/981)) ([e7cfe25](https://github.com/MaxPayne89/klass-hero/commit/e7cfe25504e7627caca53f16d9bf3cdd3197558f))

## [0.53.1](https://github.com/MaxPayne89/klass-hero/compare/v0.53.0...v0.53.1) (2026-06-12)


### Bug Fixes

* seed UI test staff user as staff-only ([#972](https://github.com/MaxPayne89/klass-hero/issues/972) follow-up) ([#975](https://github.com/MaxPayne89/klass-hero/issues/975)) ([ef1ec05](https://github.com/MaxPayne89/klass-hero/commit/ef1ec054ee705dbbb41441df62652158574a4f84))
...
* consolidate duplicate code into shared seams (16 issues) ([#937](https://github.com/MaxPayne89/klass-hero/issues/937)) ([9e66ba2](https://github.com/MaxPayne89/klass-hero/commit/9e66ba2705dc8b01cdcb89f759c46227de7559a8))
...
* show program name on broadcast inbox rows ([#895](https://github.com/MaxPayne89/klass-hero/issues/895)) ([ee0175c](https://github.com/MaxPayne89/klass-hero/commit/ee0175cf83569577a2d17456770a239bb15ffa75))
...
* allow attachments in provider and staff broadcasts ([#778](https://github.com/MaxPayne89/klass-hero/issues/778)) ([#823](https://github.com/MaxPayne89/klass-hero/issues/823)) ([5dca7ad](https://github.com/MaxPayne89/klass-hero/commit/5dca7ad7c8b424330f2d2d592cf7e190d59440f8))
...
* carry owner email + name on incident_reported payload ([#781](https://github.com/MaxPayne89/klass-hero/issues/781)) ([0510680](https://github.com/MaxPayne89/klass-hero/commit/0510680391bb7c883fef3f3e6f468c1e636e9211))

## [0.48.1](https://github.com/MaxPayne89/klass-hero/compare/v0.48.0...v0.48.1) (2026-04-30)


### Bug Fixes

* enqueue incident email atomically with submission ([#754](https://github.com/MaxPayne89/klass-hero/issues/754)) ([#773](https://github.com/MaxPayne89/klass-hero/issues/773)) ([4207808](https://github.com/MaxPayne89/klass-hero/commit/4207808aef30c09083756f763d005b050be554b0))

## [0.48.0](https://github.com/MaxPayne89/klass-hero/compare/v0.47.0...v0.48.0) (2026-04-25)


### Features

* viewable incident reports under Programs Inventory ([#757](https://github.com/MaxPayne89/klass-hero/issues/757)) ([48e216f](https://github.com/MaxPayne89/klass-hero/commit/48e216f28af0af90c57a9b92321cecf3372463e0))

## [0.47.0](https://github.com/MaxPayne89/klass-hero/compare/v0.46.0...v0.47.0) (2026-04-25)


### Features

* notify business owner by email on incident report ([#755](https://github.com/MaxPayne89/klass-hero/issues/755)) ([d8df7cc](https://github.com/MaxPayne89/klass-hero/commit/d8df7cce33b3d1adeb13847948d2620568790b93))

## [0.46.0](https://github.com/MaxPayne89/klass-hero/compare/v0.45.0...v0.46.0) (2026-04-24)


### Features

* incident reporting for providers (closes [#34](https://github.com/MaxPayne89/klass-hero/issues/34)) ([#743](https://github.com/MaxPayne89/klass-hero/issues/743)) ([af5a07f](https://github.com/MaxPayne89/klass-hero/commit/af5a07fba73ae18df24bf965da98726cc08adfbd))
...
* pay rates per staff member with Money value object ([#720](https://github.com/MaxPayne89/klass-hero/issues/720)) ([e41f6cd](https://github.com/MaxPayne89/klass-hero/commit/e41f6cdf2d15271d2ae8a2ea4e1ec22ed5070d92))

## [0.43.0](https://github.com/MaxPayne89/klass-hero/compare/v0.42.0...v0.43.0) (2026-04-21)


### Features

* allow providers to manually invite individual participants ([#715](https://github.com/MaxPayne89/klass-hero/issues/715)) ([3673b48](https://github.com/MaxPayne89/klass-hero/commit/3673b482a1e146176918ae5d14bad76eb6dc7a24))
