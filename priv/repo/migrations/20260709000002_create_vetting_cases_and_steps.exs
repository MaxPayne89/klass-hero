defmodule KlassHero.Repo.Migrations.CreateVettingCasesAndSteps do
  ...
  def change do
    ...
    # One case per provider — also the idempotency key for race-safe lazy backfill.
    ...
    create table(:verification_steps, primary_key: false) do
      ...
      # Polymorphic reference to the evidence record (document / identity session /
      # signed agreement) — intentionally NOT a foreign key.
