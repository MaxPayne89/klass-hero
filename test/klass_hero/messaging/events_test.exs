defmodule KlassHero.Messaging.EventsTest do
  @moduledoc """
  Tests for Events domain event factory module.
  """
  ...
  describe "messages_read/3" do
    test "creates event with correct type and payload" do
      ...
      event = Events.messages_read(conversation_id, user_id, read_at)
  ...
  describe "conversations_archived/4" do
    test "creates event with correct type and payload" do
      ...
      event = Events.conversations_archived(ids, :retention_policy, 2, archived_at)
  ...
  describe "message_data_anonymized/1" do
    test "creates an event with correct type and payload" do
      user_id = Ecto.UUID.generate()
      event = Events.message_data_anonymized(user_id)
  ...
  describe "participant_added/3" do
    test "creates event with correct type and payload" do
      ...
      event = Events.participant_added(conversation_id, user_ids, :initial_staff)
  ...
  describe "participant_removed/3" do
    test "creates event with correct type and payload" do
      ...
      event =
        Events.participant_removed(conversation_id, user_ids, :staff_unassignment)
