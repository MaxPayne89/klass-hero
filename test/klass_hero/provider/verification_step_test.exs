defmodule KlassHero.Provider.VerificationStepTest do
  @moduledoc """
  Tests for the VerificationStep functional core — one unit of a Vetting Case,
  frozen from a StepDefinition and moving through its status lifecycle. Pure,
