defmodule KlassHero.Provider.VettingCaseResetTest do
  @moduledoc """
  Tests for VettingCase.reset_step/2 — the reverse-edge `requires` cascade that powers
  both document-rejection recovery and the business responsible-person reset. Pure,
