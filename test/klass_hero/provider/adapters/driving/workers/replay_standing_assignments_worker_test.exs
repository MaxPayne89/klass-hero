defmodule KlassHero.Provider.Adapters.Driving.Workers.ReplayStandingAssignmentsWorkerTest do
  ...
  alias KlassHero.Provider.Adapters.Driving.Workers.ReplayStandingAssignmentsWorker
