...
The individual track's first step (ADR-0006) is completed by Stripe Identity. Stripe Identity
...
Reference: step catalog `docs/6-step-verification-process.md` (Step 1); engine ADR-0006; glossary
