...
> `VerificationStep` engine ([ADR-0006](adr/0006-provider-vetting-is-a-composable-step-engine.md)).
...
[ADR-0006](adr/0006-provider-vetting-is-a-composable-step-engine.md). This document is the step
